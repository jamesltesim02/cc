...
class Daemon:
    def __init__(self, pidfile='/var/tmp/holdem-cron.pid', stdin='/dev/null', stdout='/dev/null', stderr='/dev/null'):
        self.stdin = stdin
        self.stdout = stdout
        self.stderr = stderr
...
if __name__ == '__main__':
    ...
    LOG = '/var/tmp/holdem-cron.log'
    daemon = Daemon(pidfile=PIDFILE, stdout=LOG, stderr=LOG)
